...
2. 打开 [v4.6.0 标签页](https://github.com/fxjcangku/jerinin-addon/releases/tag/v4.6.0)，下载 GitHub 提供的 `Source code (zip)`；如果后续提供独立附件，则优先下载粘液助手发布包。
...
- `autoEquipGuide`：是否自动将背包内指南交换到副手
